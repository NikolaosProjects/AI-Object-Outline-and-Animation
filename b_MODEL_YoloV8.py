...
def selection(choice):
    if choice == 1:
        ...
        threshold = 1000
        anim_dur = 5.15
    return(url, zoomval, threshold, anim_dur)
...
ax.imshow(input_image, aspect='auto')
ax.axis('off')
plt.subplots_adjust(left=0, right=1, top=0.95, bottom=0)
ax.set_title("Selected Image", color = "White")
ax.axis('off')
plt.show()
...
ax.set_facecolor('black')
plt.subplots_adjust(left=0, right=1, top=0.95, bottom=0)
ax.set_title("AI Object Detection", color = "White")
ax.axis('off')
plt.show()
