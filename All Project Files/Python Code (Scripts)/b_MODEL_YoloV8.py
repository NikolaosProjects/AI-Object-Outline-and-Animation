...
model_url = "https://raw.githubusercontent.com/NikolaosProjects/AI-Object-Outline-and-Animation/main/All%20Project%20Files/AI%20Model/yolov8s-seg.pt"
...
model = YOLO("/home/nick/Coding/venv/2. AI Training Files/YOLOv8s-seg/Trained Model/yolov8s_seg_trained/weights/best.pt", task='segment')  # Explicitly define the task
model.to(device)
